...
<header>
	...
	<ul>
		<li><a href="#">Registrar Medicos</a></li>
...
$sql="INSERT INTO consultorios(conNombre) VALUES('$_REQUEST[identificacion]','$_REQUEST[nombres]','$_REQUEST[apellidos]','$_REQUEST[especialidad]','$_REQUEST[telefono]','$_REQUEST[correo]')"; 
